...
{{--    <link href="{{ URL::asset('theme/vendors/datatables/datatables.bundle.css')}}" rel="stylesheet" type="text/css"/>--}}
    <link rel="stylesheet" href="{{URL::asset('theme/vendors/sumoselect/sumoselect.css')}}" rel="stylesheet" type="text/css">
    <style>
        .SumoSelect {
            color: black;
            width: 90%;
...
@section('page_level_scripts')
    ...
    <script src="{{URL::asset('theme/vendors/sumoselect/sumoselect.js')}}"></script>
    <script>
