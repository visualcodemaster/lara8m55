...
var mUtil = function () {
    ...
    return {
        init: function (t) {
            ...
            var n = Element.prototype, o = n.matches || n.webkitMatchesSelector || n.mozMatchesSelector || n.msMatchesSelector || function (t) {
            ...
            var e, a;
            if (t = mUtil.get(t)) return t.getClientRects().length ? (e = t.getBoundingClientRect(), a = t.ownerDocument.defaultView, {top: e.top + a.pageYOffset, left: e.left + a.pageXOffset}) : {top: 0, left: 0}
        }, height: function (t) {
...
var mApp = function () {
    var t = {brand: "#716aca", metal: "#c4c5d6", light: "#ffffff", accent: "#00c5dc", primary: "#5867dd", success: "#34bfa3", info: "#36a3f7", warning: "#ffb822", danger: "#f4516c", focus: "#9816f4"}, e = function (t) {
        var e = t.data("skin") ? "m-tooltip--skin-" + t.data("skin") : "", a = "auto" == t.data("width") ? "m-tooltop--auto-width" : "", n = t.data("trigger") ? t.data("trigger") : "hover";
        ...
        var e = t.data("skin") ? "m-popover--skin-" + t.data("skin") : "", a = t.data("trigger") ? t.data("trigger") : "hover";
        t.popover({
            trigger: a,
        ...
        $("[data-tab-target]").each(function () {
            1 != $(this).data("tabs-initialized") && ($(this).click(function (t) {
                t.preventDefault();
                var e = $(this), a = e.closest('[data-tabs="true"]'), n = $(a.data("tabs-contents")), o = $(e.data("tab-target"));
...
$(document).ready(function () {
    ...
    t.fn.mDatatable = function (n) {
                ...
                isInit: !1, offset: 110, stateId: "meta", ajaxParams: {}, init: function (e) {
                                ...
                                0 === t(this).find(".m-datatable__lock").length && t(this).ready(function () {
                                    !function (a) {
                                        if (t(a).find(".m-datatable__lock").length > 0) i.log("Locked container already exist in: ", a); else if (0 !== t(a).find(".m-datatable__row").length) {
                                            var n = t("<div/>").addClass("m-datatable__lock m-datatable__lock--left"), l = t("<div/>").addClass("m-datatable__lock m-datatable__lock--scroll"),
                                                r = t("<div/>").addClass("m-datatable__lock m-datatable__lock--right");
                                            t(a).find(".m-datatable__row").each(function () {
                                                var e = t("<tr/>").addClass("m-datatable__row").appendTo(n), a = t("<tr/>").addClass("m-datatable__row").appendTo(l), o = t("<tr/>").addClass("m-datatable__row").appendTo(r);
                    ...
                    t(window).scroll(function (t) {
                        ...
                        if (i.hoverTimer = setTimeout(function () {
                            ...
                            var e = t(this).closest(".m-datatable__row").addClass("m-datatable__row--hover"), a = t(e).index() + 1;
                            t(e).closest(".m-datatable__lock").parent().find(".m-datatable__row:nth-child(" + a + ")").addClass("m-datatable__row--hover")
                        }
                    }).on("mouseleave", function () {
                        var e = t(this).closest(".m-datatable__row").removeClass("m-datatable__row--hover"), a = t(e).index() + 1;
                    ...
                    var e = t(o.tableHead).width(), a = t(o.tableHead).find(".m-datatable__lock--left").width(), n = t(o.tableHead).find(".m-datatable__lock--right").width();
                    ...
                    if (n.layout.height && n.layout.scroll) {
                        var e = t(o.tableHead).find(".m-datatable__row").height(), a = t(o.tableFoot).find(".m-datatable__row").height(), i = n.layout.height;
                    ...
                    var e = t(o.tableHead).width(), a = t(o.tableHead).find(".m-datatable__row:first-child").find(".m-datatable__cell:visible").length;
                    if (a > 0) {
                        e -= 20 * a;
                    ...
                    o.dataSet = o.dataSet || [];
                    var a = i.getDataSourceParam(), l = a.pagination, r = (Math.max(l.page, 1) - 1) * l.perpage, s = Math.min(l.page, l.pages) * l.perpage, d = {};
                    ...
                    i.spinnerCallback(!0);
                    var e = {dataType: "json", method: "GET", data: {}, timeout: i.getOption("data.source.read.timeout") || 3e4};
                    ...
                    var l = {
                        meta: null, pager: null, paginateEvent: null, pagerLayout: {pagination: null, info: null}, callback: null, init: function (e) {
                            ...
                            var e = i.getOption("layout.icons.pagination"), a = i.getOption("translate.toolbar.pagination.items.default");
                            ...
                            var r = i.getOption("toolbar.items.pagination.pages.desktop.pagesNumber"), s = Math.ceil(l.meta.page / r) * r, d = s - r;
                            ...
                            var e = Math.max(l.meta.perpage * (l.meta.page - 1) + 1, 1), a = Math.min(e + l.meta.perpage - 1, l.meta.total);
                            ...
                            var e = t(o.table).siblings(".m-datatable__pager").find(".m-datatable__pager-nav"), a = t(e).find(".m-datatable__pager-link--more-prev"), n = t(e).find(".m-datatable__pager-link--more-next"),
                                r = t(e).find(".m-datatable__pager-link--first"), s = t(e).find(".m-datatable__pager-link--prev"), d = t(e).find(".m-datatable__pager-link--next"), c = t(e).find(".m-datatable__pager-link--last"),
                                m = t(e).find(".m-datatable__pager-link-number"), u = Math.max(t(m).first().data("page") - 1, 1);
                    ...
                    if ("function" == typeof e && !(t(o.table).find(".m-datatable__subtable").length > 0)) {
                        ...
                        var a = function (a) {
                            ...
                            var s = t(r).find(".m-datatable__subtable"), d = t(this).closest("[data-field]:first-child").find(".m-datatable__toggle-subtable").data("value"), c = t(this).find("i").removeAttr("class");
                    ...
                    var e = function (e) {
                        ...
                        if (t(o).hasClass("m-datatable__row-detail")) t(this).find("i").removeClass(i.getOption("layout.icons.rowDetail.expand")).addClass(i.getOption("layout.icons.rowDetail.collapse")), t(o).remove(); else {
                            ...
                            var r = t("<td/>").addClass("m-datatable__detail").attr("colspan", i.getTotalColumns()).appendTo(o), s = t("<table/>");
                            t(l).each(function () {
                    ...
                    var i = t(e).index(), l = t(o.tableBody).find(".m-datatable__row"), r = t(e).closest(".m-datatable__lock").index();
                    -1 !== r && (l = t(o.tableBody).find(".m-datatable__lock:nth-child(" + (r + 1) + ")").find(".m-datatable__row"));
                    var s = t(l).parent();
                    t(l).sort(function (e, o) {
                        var l = t(e).find("td:nth-child(" + i + ")").text(), r = t(o).find("td:nth-child(" + i + ")").text();
                    ...
                    var e = {
                        init: function () {
                            ...
                            if (!t.isEmptyObject(e)) {
                                var a = t(o.tableHead).find('.m-datatable__cell[data-field="' + e.field + '"]').attr("data-sort", e.sort), n = t(a).find("span"), l = t(n).find("i"), r = i.getOption("layout.icons.sort");
                            ...
                            if ((void 0 === s.sortable || !1 !== s.sortable) && (t(o.tableHead).find(".m-datatable__cell > span > i").remove(), n.sortable)) {
                                i.spinnerCallback(!0);
                                var d = "desc";
                                i.getObject("field", l) === r && (d = i.getObject("sort", l)), l = {field: r, sort: d = void 0 === d || "desc" === d ? "asc" : "desc"}, i.setDataSourceParam("sort", l), e.setIcon(), setTimeout(function () {
                    ...
                    var n = {position: "absolute", visibility: "hidden", display: "block"}, o = {width: 0, height: 0, innerWidth: 0, innerHeight: 0, outerWidth: 0, outerHeight: 0}, i = t(e).parents().addBack().not(":visible");
                    ...
                    var a = t(e).closest(".m-datatable__row").addClass("m-datatable__row--active"), n = t(a).index() + 1;
                    ...
                    var a = t(e).closest(".m-datatable__row").removeClass("m-datatable__row--active"), n = t(a).index() + 1;
        ...
        data: {type: "local", source: null, pageSize: 10, saveState: {cookie: !1, webstorage: !0}, serverPaging: !1, serverFiltering: !1, serverSorting: !1, autoColumns: !1, attr: {rowProps: []}},
        layout: {
            theme: "default",
            ...
            icons: {
                ...
                pagination: {next: "la la-angle-right", prev: "la la-angle-left", first: "la la-angle-double-left", last: "la la-angle-double-right", more: "la la-ellipsis-h"},
        ...
        toolbar: {
            ...
            items: {
                pagination: {
                    type: "default",
                    pages: {desktop: {layout: "default", pagesNumber: 6}, tablet: {layout: "default", pagesNumber: 3}, mobile: {layout: "compact"}},
        ...
        translate: {
            ...
            toolbar: {
                pagination: {
                    items: {
                        default: {first: "First", prev: "Previous", next: "Next", last: "Last", more: "More pages", input: "Page number", select: "Select page size"},
...
mUtil.isRTL() && (defaults = {
    layout: {
        icons: {
            pagination: {next: "la la-angle-left", prev: "la la-angle-right", last: "la la-angle-double-left", first: "la la-angle-double-right"},
...
var mDropdown = function (t, e) {
    ...
    if (n) {
        var i = {toggle: "click", hoverTimeout: 300, skin: "light", height: "auto", maxHeight: !1, minHeight: !1, persistent: !1, mobileOverlay: !0}, l = {
            construct: function (t) {
                ...
                var t = mUtil.outerWidth(n), e = mUtil.hasClass(a.layout.arrow, "m-dropdown__arrow--right") ? "right" : "left", o = 0;
...
var mHeader = function (t, e) {
    ...
    if (o) {
        var l = {accordion: {slideSpeed: 200, autoScroll: !1, autoScrollSpeed: 1200, expandAll: !0}, dropdown: {timeout: 500}}, r = {
            construct: function (t) {
                ...
                a.options.scroll && a.options.scroll.height && (mUtil.scrollerDestroy(o), mUtil.scrollerInit(o, {disableForMobile: !0, resetHeightOnDestroy: !0, handleWindowResize: !0, height: a.options.scroll.height}))
                    ...
                    if (!mUtil.hasClass(o.closest(".m-menu__item"), "m-menu__item--open-always") && i && l) {
                        ...
                        if (!1 === mUtil.hasClass(i, "m-menu__item--open")) {
                            if (!1 === a.options.accordion.expandAll) {
                                var d = o.closest(".m-menu__nav, .m-menu__subnav"), c = mUtil.children(d, ".m-menu__item.m-menu__item--open.m-menu__item--submenu:not(.m-menu__item--expanded):not(.m-menu__item--open-always)");
            ...
            r = {
                construct: function (t) {
                    ...
                    if (a.options.tooltips) {
                        var t = mUtil.hasClass(n, "m-portlet--collapse") || mUtil.hasClass(n, "m-portlet--collapsed"), e = mUtil.hasClass(o, "m-portlet--fullscreen") && mUtil.hasClass(n, "m-portlet--fullscreen"),
                    ...
                    if ("off" === t || mUtil.hasClass(o, "m-portlet--fullscreen") && mUtil.hasClass(n, "m-portlet--fullscreen")) r.eventTrigger("beforeFullscreenOff"), mUtil.removeClass(o, "m-portlet--fullscreen"), mUtil.removeClass(n, "m-portlet--fullscreen"), r.removeTooltips(), r.setupTooltips(), a.foot && (mUtil.css(a.body, "margin-bottom", ""), mUtil.css(a.foot, "margin-top", "")), r.eventTrigger("afterFullscreenOff"); else {
                        if (r.eventTrigger("beforeFullscreenOn"), mUtil.addClass(n, "m-portlet--fullscreen"), mUtil.addClass(o, "m-portlet--fullscreen"), r.removeTooltips(), r.setupTooltips(), a.foot) {
                            var e = parseInt(mUtil.css(a.foot, "height")), i = parseInt(mUtil.css(a.foot, "height")) + parseInt(mUtil.css(a.head, "height"));
        ...
        var o = {startStep: 1, manualStepForward: !1}, l = {
            construct: function (t) {
                ...
                if (a.progress) if (mUtil.hasClass(n, "m-wizard--1")) {
                    var t = (a.currentStep - 1) / a.totalSteps * 100, e = mUtil.find(n, ".m-wizard__step-number"), o = parseInt(mUtil.css(e, "width"));
                ...
                var t = a.steps[a.currentStep - 1], e = mUtil.get(mUtil.attr(t, "m-wizard-target")), o = mUtil.find(n, ".m-wizard__form-step--current");
...
var mLayout = function () {
    var t, e, a, n, o, i, l = function () {
        0 !== $("#m_aside_left_hide_toggle").length && (l = new mToggle("m_aside_left_hide_toggle", {target: "body", targetState: "m-aside-left--hide", togglerState: "m-brand__toggler--active"})).on("toggle", function (a) {
        ...
        return new mPortlet("main_portlet", {
            sticky: {
                offset: parseInt(mUtil.css(mUtil.get("m_header"), "height")), zIndex: 90, position: {
                    top: function () {
    ...
    return {
        init: function () {
            ...
            }), t = new mMenu("m_header_menu", {submenu: {desktop: "dropdown", tablet: "accordion", mobile: "accordion"}, accordion: {slideSpeed: 200, expandAll: !1}}), $("#m_aside_header_topbar_mobile_toggle").click(function () {
                $("body").toggleClass("m-topbar--on")
            }), 0 !== $("#m_quicksearch").length && new mQuicksearch("m_quicksearch", {mode: mUtil.attr("m_quicksearch", "m-quicksearch-mode"), minLength: 1}).on("search", function (t) {
                t.showProgress(), $.ajax({
                    url: "https://keenthemes.com/metronic/themes/themes/metronic/dist/preview/inc/api/quick_search.php", data: {query: t.query}, dataType: "html", success: function (e) {
            ...
            s = mUtil.get("body"), d = mUtil.get("m_aside_left"), c = mUtil.hasClass(d, "m-aside-left--offcanvas-default") ? "m-aside-left--offcanvas-default" : "m-aside-left", a = new mOffcanvas("m_aside_left", {
                ...
                scroll: m,
                submenu: {desktop: {default: p, state: {body: "m-aside-left--minimize", mode: "dropdown"}}, tablet: "accordion", mobile: "accordion"},
...
var mQuickSidebar = function () {
    var t = $("#m_quick_sidebar"), e = $("#m_quick_sidebar_tabs"), a = t.find(".m-quick-sidebar__content"), n = function () {
        var a, n, o, i;
        a = mUtil.find(mUtil.get("m_quick_sidebar_tabs_messenger"), ".m-messenger__messages"), n = $("#m_quick_sidebar_tabs_messenger .m-messenger__form"), mUtil.scrollerInit(a, {
            ...
            disableForMobile: !0, resetHeightOnDestroy: !1, handleWindowResize: !0, height: function () {
    ...
    return {
        init: function () {
            0 !== t.length && new mOffcanvas("m_quick_sidebar", {overlay: !0, baseClass: "m-quick-sidebar", closeBy: "m_quick_sidebar_close", toggleBy: "m_quick_sidebar_toggle"}).one("afterShow", function () {
